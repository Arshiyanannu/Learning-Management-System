...
// import { FaArrowRight, FaBookOpen, FaUsers, FaChalkboardTeacher, FaRocket, FaCompass } from 'react-icons/fa';
...
//               className="w-full sm:w-auto bg-slate-800 hover:bg-slate-700 border border-slate-700 text-slate-200 font-semibold px-8 py-3.5 rounded-xl transition-all duration-200 flex items-center justify-center"
//             >
//               Get Started
//             </button>
//           </div>
...
//               <FaCompass />
//             </div>
//             <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight">Featured Catalogs</h2>
//           </div>
//           <button
//             onClick={() => navigate('/courses')}
